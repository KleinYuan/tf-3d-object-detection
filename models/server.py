import detector_3d, frustum_proposal, detector_2d
import numpy as np
...
class Server(object):
    ...
    DETECTOR_3D_MODEL_FP = configs.DETECTOR_3D['MODEL_FP']
    NUM_HEADING_BIN = configs.FPNET['NUM_HEADING_BIN']
    DETECTOR_2D_MODEL_FP = configs.DETECTOR_2D['MODEL_FP']
    ...
    def _init_detector_3d(self):
        ...
        self.detector_3d = detector_3d.FPNetPredictor(model_fp=self.DETECTOR_3D_MODEL_FP)
